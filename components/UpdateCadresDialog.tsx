...
const updateCadresValidationSchema = yup.object().shape({
    name: yup
        .string()
...
const UpdateCadresDialog = ({ isOpen, onClose, onSubmit, cadres }: Props) => {
    ...
    return (
        ...
        >
            ...
            <Formik
                initialValues={{
                    ...cadres,
                    gender: cadres?.female ? "female" : "male",
                }}
                onSubmit={onSubmit}
                validationSchema={updateCadresValidationSchema}
            >
                <Form>
                    <ModalContent>
...
export default UpdateCadresDialog;
